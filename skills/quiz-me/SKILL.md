---
name: "quiz-me"
description: "Quiz the user one question at a time on code just produced or discussed, then score comprehension by category. Use only when explicitly requested or when the SDLC workflow invokes it; never trigger merely because work finished."
---
...
## Purpose
Quiz the user one question at a time on code just produced or discussed, then score comprehension by category. Use only when explicitly requested or when the SDLC workflow invokes it; never trigger merely because work finished.
