...
## Purpose
Encapsulate data mapping, null handling, derived flags, and display logic in domain objects (classes or plain objects with behavior) so the view stays free of business rules and conditionals.
