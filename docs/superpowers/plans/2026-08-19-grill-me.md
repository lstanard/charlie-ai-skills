...
- [x] **Step 1: Write `skills/grill-me/skill.json`**
...
- [x] **Step 2: Validate the skill.json**
...
- [x] **Step 3: Generate SKILL.md and cursor.rule.md**

Run: `npm run gen`
Expected output includes the line: `  skills/grill-me: SKILL.md, cursor.rule.md`

- [x] **Step 4: Verify the generated files**
...
- [x] **Step 1: Write `skills/grill-me/CLAUDE.md`**
...
- [x] **Step 2: Verify against skill.json**
...
- [x] **Step 1: Add the row to the general skills table**
...
- [x] **Step 1: Run full validate + gen across all skills**
...
- [x] **Step 2: Confirm no unintended diff from regeneration**
