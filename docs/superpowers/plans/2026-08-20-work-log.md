...
- No employer-identifying strings anywhere in this skill's content — this repo is public. Use generic placeholders (`your-team.atlassian.net`, `your-github-org`, `PROJ-1234`, `program-service`, `infra-tooling`) in every example.
