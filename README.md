...
| [frontend-testing](skills/frontend-testing/)                                 | React testing strategy: Jest + RTL (behavior over implementation), Playwright for E2E; Vitest for Vite. Logic, a11y, coverage, CI. |
